    ...
    return (
        ...
        >
            ...
            <main className="mx-auto px-4 py-8 max-w-[1200px] w-full mt-8">
                {/* Sub Navigation */}
                <nav className="bg-white bg-opacity-90  rounded-lg shadow-sm" style={{ marginBottom: '1rem' }}>
                    <div className="container mx-auto px-4 py-3">
                        <ul className="flex space-x-8">
                            <li><a href="#" className="text-green-600 font-medium hover:text-green-800">Oto điện</a></li>
                            <li><a href="#" className="text-green-600 font-medium hover:text-green-800">Xe máy điện</a></li>
                            <li><a href="#" className="text-green-600 font-medium hover:text-green-800">Pin</a></li>
                        </ul>
                    </div>
                </nav>
                <div className="bg-white rounded-lg p-6">
                    ...
                    <div className="flex space-x-4 mb-6">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg ${activeTab === "recommended" ? "bg-green-500 text-white" : "bg-gray-100"}`}
                        >
                            Dành cho bạn
                        </button>
                        <button
                            onClick={() => setActiveTab("newest")}
                            className={`px-4 py-2 rounded-lg ${activeTab === "newest" ? "bg-green-500 text-white" : "bg-gray-100"}`}
                        >
                            Mới nhất
                        </button>
                    </div>
